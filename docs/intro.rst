...
This is the documentation for discord.py-selfbots, a library for Python to aid
in creating applications that utilise the Discord API.

Prerequisites
---------------

discord.py-selfbots works with Python 3.8 or higher. Support for earlier versions of Python
...
You can get the library directly from PyPI: ::
    ...
    python3 -m pip install -U discord.py-selfbots

If you are using Windows, then the following should be used instead: ::

    py -3 -m pip install -U discord.py-selfbots


To get voice support, you should use ``discord.py-selfbots[voice]`` instead of ``discord.py-selfbots``, e.g. ::

    python3 -m pip install -U discord.py-selfbots[voice]
...
3. Use pip like usual:
    ...
    .. code-block:: shell
        ...
        $ pip install -U discord.py-selfbots
...
discord.py-selfbots revolves around the concept of :ref:`events <discord-api-events>`.
