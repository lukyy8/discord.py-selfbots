...
The following section outlines the API of discord.py-selfbots.
...
discord.py-selfbots offers support for creating, editing, and executing webhooks through the :class:`Webhook` class.
