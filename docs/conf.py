#
# discord.py-selfbots documentation build configuration file, created by
...
extlinks = {
    'issue': ('https://github.com/lukyy8/discord.py-selfbots/issues/%s', 'GH-'),
}
...
resource_links = {
  ...
  'issues': 'https://github.com/lukyy8/discord.py-selfbots/issues',
  'discussions': 'https://github.com/lukyy8/discord.py-selfbots/discussions',
  'examples': f'https://github.com/lukyy8/discord.py-selfbots/tree/{branch}/examples',
}
...
htmlhelp_basename = 'discord.py-selfbotsdoc'
...
latex_documents = [
  ('index', 'discord.py-selfbots.tex', 'discord.py-selfbots Documentation',
   'Rapptz', 'manual'),
]
...
man_pages = [
    ('index', 'discord.py-selfbots', 'discord.py-selfbots Documentation',
     ['Rapptz'], 1)
]
...
texinfo_documents = [
  ('index', 'discord.py-selfbots', 'discord.py-selfbots Documentation',
   'Rapptz', 'discord.py-selfbots', 'One line description of project.',
   'Miscellaneous'),
]
